...
<div style="font-size: 18px;  line-height: 1.6; font-family: monospace; margin-top: 20px;">
Вместо того, чтобы прятать баги в рантайме или создавать нестабильные синглтоны, EasySpring кидает исключения и роняет клиентский код.<br/>
...
идти только с 1й версией прототайп бина. <br/> Это баг. EasySpring защищает программиста от подобного рода ошибок.
</div>
